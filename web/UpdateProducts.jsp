    ...
    <body>
        ...
        <div id="wrapper">
            ...
            %>
             ...
             <div class="row ">
                <div class="col-sm-12">
                    <form action="Admin?id=<%=update%>" method="POST" class="form-group">
                        ...
                        <%
                            ...
                            try{
                               ...
                               String sql = "Select nombre from producto where id_producto='"+update+"'";
                            ...
                            <input type="text" class="form-control " placeholder="Nombre" value="<%=rs.getString(1)%>" name="nombre" required>
                         <%
                             }
                             }catch(Exception e){
                         System.out.println("error al traer nombre"+e);
                            }finally{
                            cn.cerrar();
                            }
                            %>
                        ...
                        <%
                            ...
                            try{
                               ...
                               Connection con = cn.getConnection();
                               String sql = "CALL proc_modelo_pc('"+update+"')";
                               Statement st = con.createStatement();
                               ResultSet rs = st.executeQuery(sql);
                               while(rs.next()){
                            %>
                        
                            <input type="text" name="modelo_pc" class="form-control" value="<%=rs.getString(1)%>"  placeholder="modelo" required>
                       ...
                       <select class="form-control" name="categoria" required>
                        ...
                        <%
                            ...
                            try{
                               ...
                               Connection con = cn.getConnection();
                               String sql = "call proc_precio1('"+update+"')";
                               Statement st = con.createStatement();
                               ResultSet rs = st.executeQuery(sql);
                               while(rs.next()){
                            %>
                            ...
                            <input type="text" class="form-control " placeholder="precio" id="numero" value="<%=rs.getString(1)%>" name="precio" required>
                        ...
                        <select class="form-control" name="color" required>
                            ...
                            try{
                               ...
                               Connection con = cn.getConnection();
                               String sql = "CALL proc_color('"+update+"')";
                               Statement st = con.createStatement();
                               ResultSet rs = st.executeQuery(sql);
                               while(rs.next()){
                            %>
                        ...
                        <div class="col-sm-6">
                         ...
                         System.out.println("procesador"+e);
                            ...
                            try{
                               ...
                               Connection con = cn.getConnection();
                               String sql = "call proc_descripcion('"+update+"')";
                               Statement st = con.createStatement();
                               ResultSet rs = st.executeQuery(sql);
                               while(rs.next()){
                            %>
                            <input type="text" class="form-control" value="<%=rs.getString(1)%>" placeholder="descripcion" name="descripcion" required>
                             <%
                             }
                             }catch(Exception e){
                         System.out.println("procesador"+e);
                            ...
                            <br>
                            <button type="submit"  class="btn btn-primary btn-block center-block">Actualizar</button>
                            <input type="hidden" name="accion" value="updateProducts">
                            <br>
                        </div>      
                    </form>
                </div>
