<%@page import="com.Controller.SearchP"%>
					...
					<div id="store">
						...
						<div class="row">
							<!-- Product Single -->
                                               ...
                                               ArrayList<Producto> lista = p.allProductsSearch(pageid,t,SearchP.busqueda);
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									<div class="product-thumb">
                                                                        ...
                                                                        <input name="var" value="randon" type="hidden">                                                                            <input name="id_product_rand" type="hidden" value="<%=pr.getId_producto()%>">
							...
							<!-- /Product Single -->
                                                        ...
                                                        <div class="row justify-content-center mt-5 ">
                                                            <div class="col-6 ">
                                                                ...
                                                                <h4 class="alert-heading text-primary text-center"> 
                                                                    <img src="img/notexist.png">
                                                                    Lo sentimos el producto no existe
